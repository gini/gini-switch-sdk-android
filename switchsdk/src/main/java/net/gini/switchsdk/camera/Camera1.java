...
import static net.gini.switchsdk.camera.GiniCameraUtil.getLargestSize;
import static net.gini.switchsdk.camera.GiniCameraUtil.getLargestSizeWithSimilarAspectRatio;
